...
public class StandaloneRelayServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("   • Files are AES-256 encrypted client-side");
            System.out.println("   • Server only stores encrypted data");
            System.out.println("   • Automatic cleanup after expiry");
            System.out.println();
